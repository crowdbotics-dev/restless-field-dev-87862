...
## Project Structure
    ...
    ├── restless_field_dev_87862  # Django project configurations
...
1. Clone this repo and `cd restless_field_dev_87862`
...
2. Clone this repo and `cd restless_field_dev_87862`
