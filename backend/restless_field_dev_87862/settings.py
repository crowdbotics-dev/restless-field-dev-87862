"""
Django settings for restless_field_dev_87862 project.
...
ROOT_URLCONF = 'restless_field_dev_87862.urls'
...
WSGI_APPLICATION = 'restless_field_dev_87862.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_field_dev_87862 API",
    "DESCRIPTION": "API documentation for restless_field_dev_87862 App",
    "VERSION": "v1",
}
